...
1. Prepare a good self introduction and final questions
1. Try out mock coding interviews (with Google and Facebook engineers)
1. (If you have extra time) Internalize key tech interview question patterns
...
- Algorithms study cheat sheets - covers the best learning resources, must remembers (tips, corner cases) and must do practice questions for every data structure and algorithm
